...
|COD\_TIPO\_MAQUINA|VARCHAR(50)|XX99999||NOT NULL, UNIQUE|Identificador único del tipo de máquina|
...
|**Atributo**|**Tipo de Dato**|**Formato**|**Clave**|**Valores Válidos**|**Semántica**|
| :-: | :-: | :-: | :-: | :-: | :-: |
|ID\_EJEMPLAR\_MAQUINA|SERIAL|Número secuencial|PK|NOT NULL, UNIQUE|Identificador único del ejemplar de maquina|
|COD\_EJEMPLAR\_MAQUINA|VARCHAR(100)|XX99999||NOT NULL, UNIQUE|Identificador único del ejemplar de maquina|
...
|COD\_SOLICITUD\_MANTENIMIENTO|SERIAL|XX99999||NOT NULL, UNIQUE|Identificador único de la solicitud de mantenimiento|
...
|COD\_ORDEN\_MANTENIMIENTO|VARCHAR(50)|XX99999|PK|NOT NULL, UNIQUE|Identificador único de la orden de mantenimiento|
...
|FECHA\_FINALIZACION|VARCHAR(50)|Texto||NOT NULL|Fecha en la que finalizó la orden de mantenimiento|
|ESTADO|VARCHAR(30)|Texto||TAB|Estado de la orden de mantenimiento|
...
|COD\_SOLICITUD\_PRODUCCION|VARCHAR(50)|XX99999|PK|NOT NULL, UNIQUE|Identificador único de la solicitud de producción|
...
|COD\_ORDEN\_PRODUCCION|VARCHAR(50)|XX99999|PK|NOT NULL, UNIQUE|Identificador único de la orden de producción|
...
|ETAPA\_PRODUCCION|VARCHAR(30)|Texto||TAB1|Estado del lote de producto|
|ESTADO|VARCHAR(30)|Texto||TAB|Estado del lote de producto|
