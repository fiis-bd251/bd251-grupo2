...
|ESTADO|VARCHAR(13)|Texto||TAB15|Estado del proceso de dosificado|Facilita el seguimiento de cada proceso de dosificado para Control de Calidad y Control de Producción|
...
|ESTADO|VARCHAR(13)|Texto||TAB15|Estado del proceso recurrente.|Facilita el seguimiento de cada proceso recurrente.|
...
|TIPO\_BOQUILLA|VARCHAR(5)|XXX99||TAB|Tipo de boquilla utilizado en el proceso|Determina la forma de la masa según las especificaciones del lote de producto|
...
|NUMERO\_BATCH|NUMERIC(2)|99||>0|Identificador del ciclo de producción dentro de un lote. |Permite rastrear los ciclos internos del proceso de producción dentro de un lote. Facilita la trazabilidad y control de calidad.|
|TIPO\_ENVASE|VARCHAR(17)|Texto||TAB18|Tipo de envase del producto|Sirve para determinar el insumo específico con el que se envasó el producto|
...
|ESTADO|VARCHAR(13)|Texto||TAB15|Estado del proceso de envasado|Facilita el seguimiento de cada proceso de envasado|
