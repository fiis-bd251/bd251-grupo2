...
![Flujo de Procesos](Imagenes/RRHH/RRHH.png)
| N° | Actividad |Descripción     | Responsable    |
|----|------------------------|------------------|----------------|
| 1  | **Recepción de Perfiles** | El jefe de RRHH recibe una lista de perfiles de nuevos empleados | Jefe de RRHH |
| 2  | **Registrar datos personales**   | El jefe de RRHH registra los datos personales y de contacto de los empleados | Jefe de RRHH |
| 3  | **Registrar contrato** | El jefe de RRHH registra los datos y detalles de asignación del contrato | Jefe de RRHH |
| 4  | **Notificar la incorporación**   | El jefe de RRHH notifica a los jefes de cada departamento la incorporación de nuevos empleados | Jefe de RRHH  |
| 5  | **Registrar renovación de contrato**   | El jefe de RRHH registra un nuevo contrato cuando culmina el periodo de alguno y se desea renovarlo | Jefe de RRHH |
| 6  | **Notificar la renovación** | El jefe de RRHH notifica a los jefes de cada departamento la reincorporación de los empleados cuyo periodo de contrato culminó | Jefe de RRHH |
| 7  | **Actualizar estado de contrato**  | El jefe de RRHH registra el cese del empleado cuando no se requiere la renovación de su contrato y se le notifica | Jefe de RRHH |
| 8  | **Evaluar propuesta de cambio de asignación**   | El jefe de RRHH evalúa y decide si aprobar o no un cambio de asignación del empleado a otro departamento, cargo o turno. Esta decisión deberá notificarse tanto al empleado como al jefe del departamento correspondiente | Jefe de RRHH |

### Módulo Almacén de Productos Terminados
