...
|TIEMPO\_PROCESO|Descriptivo|Numérico|Valores mayores a cero|minutos|—|Duración total del proceso de mezclado por ejemplar de máquina|Permite monitorear los tiempos de mezclado por máquina y compararlo con el promedio en Control de Calidad|
|PESO\_INICIAL|Descriptivo|Numérico|Valores mayores a cero|kilogramos||Cantidad de producto intermedio al iniciar el proceso de mezclado|Documenta el dato ingresado por el operario para el análisis correspondiente de Control de Calidad|
|MERMA|Descriptivo|Numérico|Valores mayores a cero|kilogramos|—|Cantidad de masa perdida que ocurre durante el proceso de mezclado por ejemplar de máquina|Documenta las pérdidas para el análisis correspondiente de Control de Calidad|
